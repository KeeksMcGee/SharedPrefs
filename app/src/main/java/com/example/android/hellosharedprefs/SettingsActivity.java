...
public class SettingsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final String SPINNER_KEY = "selected_item";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        String savedSpinnerSetting = mPreferences.getString(SPINNER_KEY, "Default");
        if(spinner !=null){
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
        spinner_item = adapterView.getItemAtPosition(position).toString();
        switch(spinner_item){
            case "Default":
                ...
                break;
            case "Black":
                spinnerSelectedColor = ContextCompat.getColor(this, R.color.black_background);
    ...
    public void saveClick(View view) {
        ...
        editor.putString(SPINNER_KEY, currentSpinnerSetting);
    ...
    public void resetClick(View view) {
        ...
        editor.apply();
        Toast.makeText(this,"Settings were reset", Toast.LENGTH_SHORT).show();
    }
}
